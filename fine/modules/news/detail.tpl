...
<div class="news_column panel panel-default">
    <div class="panel-body other-news">
        <!-- BEGIN: topic -->
        <div class="clearfix">
            <p class="body-title h3"><span class="body-after">{LANG.topic}</span></p>
            <div class="clearfix">
                <ul class="detail-related related list-none list-items">
                    <!-- BEGIN: loop -->
                    <div class="col-sm-24 col-md-12" style="min-height:120px;">
                        <a href="{TOPIC.link}" {TOPIC.target_blank} <!-- BEGIN: tooltip -->data-placement="{TOOLTIP_POSITION}" data-content="{TOPIC.hometext_clean}" data-img="{TOPIC.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{TOPIC.title}"><h4><img alt="{TOPIC.title}" src="{TOPIC.imghome}" class="img-thumbnail pull-left mr-1" style="width:150px;height:100px;"/><em class="fa fa-angle-right">&nbsp;</em>{TOPIC.title}</a></h4>
                        <!-- BEGIN: newday -->
        ...
        <!-- BEGIN: related_new -->
        <p class="body-title h3"><span class="body-after">{LANG.related_new}</span></p>
        <div class="clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <div class="col-sm-24 col-md-12" style="min-height:120px;">
                    <a href="{RELATED_NEW.link}" {RELATED_NEW.target_blank} <!-- BEGIN: tooltip -->data-placement="{TOOLTIP_POSITION}" data-content="{RELATED_NEW.hometext_clean}" data-img="{RELATED_NEW.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{RELATED_NEW.title}"><h4><img alt="{RELATED_NEW.title}" src="{RELATED_NEW.imghome}" class="img-thumbnail pull-left mr-1" style="width:150px;height:100px;"/><em class="fa fa-angle-right">&nbsp;</em>{RELATED_NEW.title}</a></h4>
                    <!-- BEGIN: newday -->
                    <span class="icon_new">&nbsp;</span>
                    <!-- END: newday -->
                </div>
        ...
        <!-- BEGIN: related -->
        <p class="body-title h3"><span class="body-after">{LANG.related}</strong></p>
        <div class="clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <div class="col-sm-24 col-md-12" style="min-height:120px;">
                    <a href="{RELATED.link}" {RELATED.target_blank} <!-- BEGIN: tooltip --> data-placement="{TOOLTIP_POSITION}" data-content="{RELATED.hometext_clean}" data-img="{RELATED.imghome}" data-rel="tooltip"<!-- END: tooltip --> title="{RELATED.title}"><h4><img alt="{RELATED.title}" src="{RELATED.imghome}" class="img-thumbnail pull-left mr-1" style="width:150px;height:100px;"/><em class="fa fa-angle-right">&nbsp;</em>{RELATED.title}</a></h4>
                    <!-- BEGIN: newday -->
                    <span class="icon_new">&nbsp;</span>
                    <!-- END: newday -->
                </div>
